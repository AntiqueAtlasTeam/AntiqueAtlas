...
public class ShortDimensionUpdatePacket extends AbstractClientMessage<ShortDimensionUpdatePacket> implements TilesPacket {
	...
	public ShortDimensionUpdatePacket() {}

	public ShortDimensionUpdatePacket(int atlasID, int dimension) {
