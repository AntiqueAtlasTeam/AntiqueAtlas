...
public class TextureSet {
	...
	public static final TextureSet JUNGLE_EDGE	= standard("JUNGLE_EDGE", TILE_GRASS2, TILE_GRASS3, TILE_GRASS4, TILE_JUNGLE_EDGE, TILE_JUNGLE_EDGE2, TILE_JUNGLE_EDGE3);
	public static final TextureSet JUNGLE_EDGE_HILLS = standard("JUNGLE_EDGE_HILLS", TILE_GRASS_HILLS, TILE_GRASS_HILLS, TILE_JUNGLE_EDGE_HILLS, TILE_JUNGLE_EDGE_HILLS2, TILE_JUNGLE_EDGE_HILLS3);
