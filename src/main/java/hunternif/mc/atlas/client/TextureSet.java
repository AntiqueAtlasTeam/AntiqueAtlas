...
public class TextureSet {
	...
	public static final TextureSet SAVANNA		= standard("SAVANNA", TILE_GRASS, TILE_GRASS2, TILE_GRASS2, TILE_GRASS3, TILE_GRASS3,
			TILE_GRASS4, TILE_GRASS4, TILE_SAVANNA, TILE_SAVANNA2, TILE_SAVANNA3);
