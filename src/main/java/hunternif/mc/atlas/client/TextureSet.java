...
public class TextureSet {
	...
	static {
		...
		LAVA.stitchTo(NETHER_BRIDGE, NETHER_BRIDGE_GATE, NETHER_TOWER,
				NETHER_BRIDGE_X, NETHER_BRIDGE_END_X,
				NETHER_BRIDGE_Z, NETHER_BRIDGE_END_Z);
		stitchMutuallyHorizontally(NETHER_BRIDGE, NETHER_BRIDGE_GATE, NETHER_TOWER, NETHER_BRIDGE_X, NETHER_BRIDGE_END_X);
		stitchMutuallyVertically(NETHER_BRIDGE, NETHER_BRIDGE_GATE, NETHER_TOWER, NETHER_BRIDGE_Z, NETHER_BRIDGE_END_Z);
	}
