...
public class AtlasData extends PersistentState {
	...
	private final Map<RegistryKey<DimensionType> /*dimension ID*/, DimensionData> dimensionMap =
	...
	public void fromTag(CompoundTag compound) {
		...
		for (int d = 0; d < dimensionMapList.size(); d++) {
			...
			dimensionID = RegistryKey.of(Registry.DIMENSION_TYPE_KEY, new Identifier(dimTag.getString(TAG_DIMENSION_ID)));
