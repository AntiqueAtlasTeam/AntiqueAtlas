...
public class GlobalMarkersData extends MarkersData {
	...
	@Override
	public Marker createAndSaveMarker(String type, String label, RegistryKey<DimensionType> dimension, int x, int y, boolean visibleAhead) {
	...
	@Override
	protected MarkersPacket newMarkersPacket(int atlasID, RegistryKey<DimensionType> dimension) {
