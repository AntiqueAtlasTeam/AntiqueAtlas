...
public interface TileAPI {
     ...
     */
    void putTile(World world, int atlasID, ResourceLocation tile, int chunkX, int chunkZ);
     ...
     */
    ResourceLocation getTile(World world, int atlasID, int chunkX, int chunkZ);
     ...
     * @param chunkZ   z chunk coordinate. (block coordinate >> 4)
     */
    void putGlobalTile(World world, ResourceLocation tile, int chunkX, int chunkZ);
     ...
     * @return the identifier of the requested tile
     */
    ResourceLocation getGlobalTile(World world, int chunkX, int chunkZ);
